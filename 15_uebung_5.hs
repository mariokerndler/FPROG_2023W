...
{-
beispielZustand :: Zustand
beispielZustand _ = P N

beispielAusdruck :: ArithAusdruck
beispielAusdruck = Abs (Ml (Ps (V X) (V Y)) (K (P (P (P N)))))
-}
------------------------------------------------------------------------------------
-- A4
------------------------------------------------------------------------------------
...
beispielProgramm :: Programm
beispielProgramm = [Zw X (K (P (P N))), Zw Y (Ps (V X) (K (P (P (P N))))), Zw Z (Ms (V Y) (K (P N))), Skip]

ergebnisZustand :: Zustand
ergebnisZustand = int beispielProgramm beispielZustand

anfangsZustand :: Zustand
anfangsZustand _ = N

ergebnis :: Zustand
ergebnis = int beispielProgramm anfangsZustand
-}
